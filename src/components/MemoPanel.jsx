...
export default function MemoPanel({ sessionMeta, projectId, sessionId, serverId = null }) {
  ...
  return (
    <div className="memo-panel">
      ...
      <MemoExportBar sessionMeta={sessionMeta} projectId={projectId} sessionId={sessionId} serverId={serverId} />
    </div>
  )
}
